...
<div class="grid px-10 md:px-48 grid-rows-7 grid-cols-1 md:grid-cols-7 gap-4">
    ...
    <button on:click={saveSelection} class="font-semibold text-lg text-left md:text-right md:row-start-7 md:col-start-6 md:row-span-1 md:col-span-1">Save</button>
